    ...
    >
      ...
      <div className="p-4 flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between min-h-0">
          <span className={`text-[11px] font-medium px-2.5 py-1 rounded-full border leading-none ${tagColors[category] || tagColors.Other}`}>
            {category}
          </span>
          {ad.is_sponsored && (
        ...
        {/* Title */}
        <h3 className="font-semibold text-sm text-surface-900 leading-snug group-hover:text-brand-700 transition-colors">
          {ad.title}
        </h3>
