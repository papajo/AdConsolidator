      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-1.5">
            ...
            {ad.is_sponsored && (
              <span className="w-1.5 h-1.5 rounded-full bg-amber-400" title="Sponsored" />
            )}
          </div>
        ...
        {/* Title */}
        <h3 className="font-display text-base text-surface-900 mb-1.5 group-hover:text-brand-700 transition-colors line-clamp-2">
          {ad.title}
        </h3>

        {/* Description */}
        <p className="text-xs text-surface-600 leading-relaxed mb-3 line-clamp-2">
          {ad.description}
        </p>
        ...
        <div className="flex items-center justify-between pt-2.5 border-t border-surface-100">
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            <span className="text-xs text-surface-500 truncate">{ad.location}</span>
          </div>
